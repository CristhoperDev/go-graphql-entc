...
func ID(id uuid.UUID) predicate.Film {
...
func IDEQ(id uuid.UUID) predicate.Film {
	return predicate.Film(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldID), id))
	})
}
...
func IDNEQ(id uuid.UUID) predicate.Film {
	return predicate.Film(func(s *sql.Selector) {
...
func IDIn(ids ...uuid.UUID) predicate.Film {
	return predicate.Film(func(s *sql.Selector) {
...
func IDNotIn(ids ...uuid.UUID) predicate.Film {
	return predicate.Film(func(s *sql.Selector) {
		// if not arguments were provided, append the FALSE constants,
		// since we can't apply "IN ()". This will make this predicate falsy.
		if len(ids) == 0 {
...
func IDGT(id uuid.UUID) predicate.Film {
	return predicate.Film(func(s *sql.Selector) {
...
func IDGTE(id uuid.UUID) predicate.Film {
	return predicate.Film(func(s *sql.Selector) {
...
func IDLT(id uuid.UUID) predicate.Film {
	return predicate.Film(func(s *sql.Selector) {
...
func IDLTE(id uuid.UUID) predicate.Film {
	return predicate.Film(func(s *sql.Selector) {
...
func Status(v int8) predicate.Film {
	return predicate.Film(func(s *sql.Selector) {
...
func UpdatedAt(v time.Time) predicate.Film {
	return predicate.Film(func(s *sql.Selector) {
...
func StatusEQ(v int8) predicate.Film {
	return predicate.Film(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldStatus), v))
	})
}
...
func StatusNEQ(v int8) predicate.Film {
	return predicate.Film(func(s *sql.Selector) {
...
func StatusIn(vs ...int8) predicate.Film {
...
func StatusNotIn(vs ...int8) predicate.Film {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func StatusGT(v int8) predicate.Film {
	return predicate.Film(func(s *sql.Selector) {
...
func StatusGTE(v int8) predicate.Film {
	return predicate.Film(func(s *sql.Selector) {
...
func StatusLT(v int8) predicate.Film {
	return predicate.Film(func(s *sql.Selector) {
...
func StatusLTE(v int8) predicate.Film {
	return predicate.Film(func(s *sql.Selector) {
...
func UpdatedAtEQ(v time.Time) predicate.Film {
	return predicate.Film(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldUpdatedAt), v))
	})
}
...
func UpdatedAtNEQ(v time.Time) predicate.Film {
	return predicate.Film(func(s *sql.Selector) {
...
func UpdatedAtIn(vs ...time.Time) predicate.Film {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func UpdatedAtNotIn(vs ...time.Time) predicate.Film {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func UpdatedAtGT(v time.Time) predicate.Film {
	return predicate.Film(func(s *sql.Selector) {
...
func UpdatedAtGTE(v time.Time) predicate.Film {
	return predicate.Film(func(s *sql.Selector) {
...
func UpdatedAtLT(v time.Time) predicate.Film {
	return predicate.Film(func(s *sql.Selector) {
...
func UpdatedAtLTE(v time.Time) predicate.Film {
	return predicate.Film(func(s *sql.Selector) {
...
func HasAuthors() predicate.Film {
	return predicate.Film(func(s *sql.Selector) {
...
func HasAuthorsWith(preds ...predicate.Author) predicate.Film {
	return predicate.Film(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
